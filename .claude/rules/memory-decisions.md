...
<!-- DRAFT: review and edit before treating as permanent -->
<!-- Drafted 2026-05-06 — edit or delete below -->
- Updated project structure trees in both CLAUDE.md and README.md to reflect LightRAG Enhanced architecture:\n\n**Changes:**\n- **CLAUDE.md (lines 200-209)** â†’ Expanded `tools/lightrag/` structure to show new subdirectories\n- **README.md (lines 329-339)** â†’ Expanded `tools/lightrag/` structure to show new subdirectories\n\n**New structure documented:**\n- `src/` â€” Enhanced implementation with config, embedders, adapters, ingestors\n- `schema/` â€” Backend setup scripts (Supabase SQL)\n- `setup_backends.py` â€” Backend validation\n- `.env.example` â€” Now described as \"Configuration template with all options\"\n\nAll other references (routing table, skill descriptions, setup steps) already generic enough â€” no changes needed."}
...
- **Architecture** (lines 182-234) â€” detailed tree with inline annotations\n5.
